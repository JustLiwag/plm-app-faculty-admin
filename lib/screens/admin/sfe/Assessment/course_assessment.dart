          ...
          children: [
              ...
              child: BarChart(
                BarChartData(
                  ...
                  barGroups: [
                    BarChartGroupData(
                      x: 0,
                      barRods: [BarChartRodData(y: 200, colors: [Colors.green])],
                    ),
                    BarChartGroupData(
                      x: 1,
                    ...
                    BarChartGroupData(
                      x: 3,
                      barRods: [BarChartRodData(y: 350, colors: [Colors.red])],
                    ),
                    BarChartGroupData(
                      x: 4,
                      barRods: [BarChartRodData(y: 400, colors: [Colors.redAccent])],
                    ),
                  ],
                ),
              ),
            ...
            const Row(
              ...
              children: [
                ...
                Text('Best: 450', style: TextStyle(fontSize: 16, color: Colors.green)),
                Text('Worst: 750', style: TextStyle(fontSize: 16, color: Colors.red)),
              ],
            ),
          ],
        ),
